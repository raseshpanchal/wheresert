        ...
        <div class="container">
            <div class="columns" style="margin-top:20px">
                ...
                <div class="column">
                    ...
                    <!--Page Title Starts-->
                    <div class="boxTitle">
                        <h3 class="pageTitle">EDIT AUDIO TITLE
                        ...
                        <form name="myAudioForm" id="myAudioForm" method="POST">
                            <div class="columns">
                                <div class="column">
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <input class="input is-primary" type="text" name="txt_audioTitle" id="txt_audioTitle" placeholder="Enter Title*" value="<?=$myAudioTitle?>">
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnSave').click(function() {
                ...
                if (myTitle != '') {
                    $.post("app/audioEditFormEntry?ID=<?=$newID?>",
