        ...
        <div class="container">
            <div class="columns" style="margin-top:20px">
                ...
                <div class="column">
                    ...
                    <!--Page Title Starts-->
                    <div class="boxTitle">
                        <h3 class="pageTitle">PHOTO GALLERY
                    ...
                    <div class="box">
                        <form name="myFormPhoto" id="myFormPhoto" method="POST" enctype="multipart/form-data" action="app/photoAddFormEntry">
                            <div class="columns">
                                <div class="column">

                                    <div class="field">
                                        <div class="control">
                                            <input class="input is-primary" type="text" name="txt_photoTitle" id="txt_photoTitle" placeholder="Enter Title*">
                                        </div>
                                    </div>
                            ...
                            <div class="columns">
                                ...
                                <div class="column">
                                    <button class="button is-danger is-pulled-right" id="btnUpload" onclick="profileImage()" style="margin-left:10px">Save</button>
