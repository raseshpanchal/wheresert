        ...
        <div class="container">
            <div class="columns" style="margin-top:20px">
                ...
                <div class="column">
                    ...
                    <!--Page Title Starts-->
                    <div class="boxTitle">
                        <h3 class="pageTitle">PROFILE RATING
                    ...
                    <div class="box">
                        ...
                        <ul class="myList">
                            <?php
                            $review_user=mysqli_query($link, "SELECT * FROM freelancer_reviews WHERE UserID='$userID' ORDER BY ReviewDate DESC");
                            while($view_review=mysqli_fetch_array($review_user))
                            {
                                ...
                                {
                                    ?>
                            <a href="myRatingBody?RID=<?=$reviewID?>">
                                <li style="color:#000"><?=$reviewName?> <span>
