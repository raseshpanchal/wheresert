<?php
    ...
    echo $myPdfName=$view_pdf['FileName'];
?>
        ...
        <div class="container">
            <div class="columns" style="margin-top:20px">
                ...
                <div class="column">
                    ...
                    <!--Page Title Starts-->
                    <div class="boxTitle">
                        <h3 class="pageTitle">DELETE PHOTO
                        ...
                        <form name="myFormPdf" id="myFormPdf" method="POST">
                            <div class="columns">
                                <div class="column">
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <input class="input is-primary" type="text" name="txt_pdfTitle" id="txt_pdfTitle" placeholder="Enter Title*" value="<?=$myPdfTitle?>" readonly>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnSave').click(function() {
                ...
                $.post("app/pdfDeleteFormEntry?ID=<?=$newID?>",
                    $("#myFormPdf").serialize(),
                    function(data) {
                        if (data == 'pdf_1') {
                            window.location.href = "myAccount";
