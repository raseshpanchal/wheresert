        ...
        <div class="container">
            <div class="columns" style="margin-top:20px">
                ...
                <div class="column">
                    ...
                    <!--Page Title Starts-->
                    <div class="boxTitle">
                        <h3 class="pageTitle">ONLINE INQUIRIES / EMAILS
                    ...
                    <div class="box">
                        ...
                        <ul class="myList">
                            <?php
                            $email_user=mysqli_query($link, "SELECT * FROM freelancer_inquiries WHERE UserID='$userID' ORDER BY PostDate DESC");
                            while($view_email=mysqli_fetch_array($email_user))
                            {
                                ...
                                {
                                    ?>
                            <a href="myEmailBody?EID=<?=$emailID?>">
                                <li style="color:red"><?=$emailFullNameCity?> <span><?=$emailPostDate?></span></li>
                            </a>
                            <?php
                                }
                                else
                                {
                                    ?>
                            <a href="myEmailBody?EID=<?=$emailID?>">
                                <li style="color:#000"><?=$emailFullNameCity?> <span><?=$emailPostDate?></span></li>
                            </a>
                            <?php
                                }
                                ?>
