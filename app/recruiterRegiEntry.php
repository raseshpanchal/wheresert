        ...
        else
        {
            ...
            if($checkContact==1)
            {
                ...
                else
                {
                    ...
                    //Insert Into DB
                    $query_1=mysqli_query($link, "INSERT INTO recruiter_registration SET FirstName='$myFirstName', LastName='$myLastName', EmailMobile='$myContact', DOB='$userBOD', Gender='$myGender', Password='$myPassword', CreateDate=now(), CreateTime=now(), PaidPhoto='No', PaidBanners='No', PaidListing='No', Status='New'");
                    if($query_1)
                    {
                        echo '1';
                    }
