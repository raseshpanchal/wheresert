...
$(document).ready(function(){
    $("#btnSave").click(function(){
        ...
        $.post("app/deleteSubCategoryEntry?ID=<?php echo $newID ?>",
        $("#myForm").serialize(),
        function(data){
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        <input type="text" class="form-control form-require" id="txt_title" name="txt_title" value="<?php echo $newTitle ?>" readonly="readonly" />
    </div>
</div>

<div class="row" style="padding:15px">
    <div class="col-xs-6">
        <label><input type="checkbox" id="chk_publish" name="chk_publish" <?php if($newPublish=='Yes') echo 'checked="checked"'; ?> disabled="disabled"> Publish Online</label>
    </div>
