...
<script src="app/js/validBlog.js"></script>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validBlog()">Save</button>
    </div>
</div>
