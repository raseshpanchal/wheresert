...
$(document).ready(function(){
    $("#btnSave").click(function(){
        ...
        $.post("app/deleteLanguageEntry?ID=<?php echo $newID ?>",
        $("#myForm").serialize(),
        function(data){
...
<div class="row" style="padding:15px;">
    <div class="col-xs-12">
        <input type="text" class="form-control form-require" id="txt_title" name="txt_title" value="<?php echo $newLanguage ?>" required placeholder="Title*" readonly />
    </div>
</div>
