...
$(document).ready(function(){	
	...
	$("#btnSave").click(function(){
		...
		$.post("app/deleteAboutUsEntry?ID=<?php echo $newID; ?>",
		$("#myForm").serialize(),
		function(data){
...
<div class="row" style="padding:15px; padding-bottom:5px;">
    <div class="col-xs-12">
        <input type="text" class="form-control form-require" value="<?php echo $newAboutTitle; ?>" readonly="readonly" />
    </div>
</div>

<div class="row" style="padding:15px; padding-top:0px;">
    <div class="col-xs-12">
        <textarea class="form-control form-require textarea" style="resize: none; height:300px;" readonly="readonly"><?php echo urldecode($newAboutDesc); ?></textarea>
    </div>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validAboutUs()">Delete</button>
    </div>
</div>
