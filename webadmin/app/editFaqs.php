...
$(document).ready(function(){	
	...
	$("#btnSave").click(function(){
		...
		$.post("app/editFaqsEntry?ID=<?php echo $newID; ?>",
		$("#myForm").serialize(),
		function(data){
			//Show Edited Table Row
			$("#1_<?php echo $newID ?>").css('background-color','#a3d3d1');
			$("#2_<?php echo $newID ?>").html(myShow+' '+$('#txt_faqTitle').val());
			//Additional Actions
...
<div class="row" style="padding:15px; padding-bottom:5px;">
    <div class="col-xs-12">
        <input type="text" class="form-control form-require" id="txt_faqTitle" name="txt_faqTitle"  value="<?php echo $newFaqTitle; ?>" required />
    </div>
</div>

<div class="row" style="padding:15px; padding-top:0px;">
    <div class="col-xs-12">
        <textarea class="form-control form-require textarea" id="txt_faqDesc" name="txt_faqDesc"  style="resize: none; height:300px;" required><?php echo urldecode($newFaqDesc); ?></textarea>
    </div>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validFaqPage()">Update</button>
    </div>
</div>
