...
<div class="row" style="padding:15px; padding-bottom:5px;">
    <div class="col-xs-12">
        <input type="text" class="form-control form-require" id="txt_faqTitle" name="txt_faqTitle" placeholder="Faq Title*" required />
    </div>
</div>

<div class="row" style="padding:15px; padding-top:0px;">
    <div class="col-xs-12">
        <textarea class="form-control form-require textarea" id="txt_faqDesc" name="txt_faqDesc" placeholder="Enter Faq Information*" style="resize: none; height:300px;" required></textarea>
    </div>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validFaqPage()">Save</button>
    </div>
</div>
