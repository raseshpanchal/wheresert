...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validRecruiter()">Save</button>
    </div>
</div>
