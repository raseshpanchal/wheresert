...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>List of All Blocked Freelancers Profile</td>
    ...
    <table class="table table-striped table-bordered table-hover">
        <thead>
            <tr style="background-color:#d9592d; color:#FFF; border-top:solid 1px #d9592d">
                ...
                <th width="50" style="text-align:center">Mobile</th>
                <th width="50" style="text-align:center">Gender</th>
                <th width="200" style="text-align:left">Business Title</th>
                <th width="150" style="text-align:left">Profession</th>
                <th width="100" style="text-align:left">City</th>
...
<!--                <th width="40" style="text-align:center">Del</th>-->
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysqli_query($link, "SELECT * FROM freelancer_registration WHERE Status='Blocked' ORDER BY ID DESC");
			while($view_1=mysqli_fetch_array($query_1))
			{
				...
				$newBusinessTitle=$view_1['BusinessTitle'];
				$newProfessional=$view_1['Professional'];
				$newCity=$view_1['City'];
			...
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
                ...
                <td id="2_<?php echo $newID ?>"><?php echo $newFirstName; ?> <?php echo $newLastName ?></td>
                <td id="3_<?php echo $newID ?>" width="250" align="left"><?php echo $newEmailID; ?></td>
                <td id="4_<?php echo $newID ?>" width="50" align="center"><?php echo $newMobile; ?></td>
                <td id="5_<?php echo $newID ?>" width="50" align="center"><?php echo $newGender; ?></td>
                <td id="6_<?php echo $newID ?>" width="200" align="left"><?php echo $newBusinessTitle; ?></td>
                <td id="7_<?php echo $newID ?>" width="150" align="left"><?php echo $newProfessional; ?></td>
                <td id="8_<?php echo $newID ?>" width="100" align="left"><?php echo $newCity; ?></td>
                <td id="9_<?php echo $newID ?>" width="30" align="center"><?php echo $showImage; ?></td>
