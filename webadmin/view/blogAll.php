...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
            $i=1;
            $query_1=mysqli_query($link, "SELECT * FROM blogs ORDER BY ID DESC");
            while($view_1=mysqli_fetch_array($query_1))
            {
                $newID=$view_1['ID'];
                $newBlogTitle=urldecode($view_1['BlogTitle']);
                $newBlogDate=$view_1['BlogDate'];
            ...
            ?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
                ...
                <td id="3_<?php echo $newID ?>" width="100" align="center">
                    <?=$newBlogDate?>
                </td>
                <td width="40" align="center">
                    <a href="app/viewBlog?ID=<?=$newID?>" class="btnView">
                        <img src="images/doc.png" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/editBlog?ID=<?php echo $newID; ?>" class="btnEdit">
                        <img src="images/edit.gif" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteBlog?ID=<?php echo $newID; ?>" class="btnDelete">
