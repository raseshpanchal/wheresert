        ...
        <div class="container">
            <div class="columns" style="margin-top:20px">
                ...
                <div class="column">
                    ...
                    <!--Page Title Starts-->
                    <div class="boxTitle">
                        <h3 class="pageTitle">AUDIO GALLERY
                        ...
                        <form name="myFormAudio" id="myFormAudio" method="POST" enctype="multipart/form-data" action="app/audioAddFormEntry">
                            <div class="columns">
                                <div class="column">
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <input class="input is-primary" type="text" name="txt_audioTitle" id="txt_audioTitle" placeholder="Enter Title*">
                                        </div>
                                    </div>
                            ...
                            <div class="columns">
                                ...
                                <div class="column">
                                    <button class="button is-danger is-pulled-right" id="btnUpload" onclick="profileAudio()" style="margin-left:10px">Save</button>
        ...
        <div class="container">
            <div class="columns" style="margin-top:20px">
                ...
                <div class="column">
                    ...
                    <!--Page Title Starts-->
                    <div class="boxTitle">
                        <h3 class="pageTitle">MY AUDIO FILES
                            <img src="images/home.png" class="settingIcon" id="myHome" />
                        </h3>
                    </div>
                    <!--Page Title Ends-->
